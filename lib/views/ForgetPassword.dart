...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  sendEmail(emailm) async{
    processingDialog(PLEASE_WAIT_WHILE_PROCESSING);
    // Future<void> resetPassword(String email) async {
      try {

        await FirebaseAuth.instance
            .sendPasswordResetEmail(email: emailm);
        // await FirebaseAuth.instance.sendPasswordResetEmail(email: emailm);
        print("Password reset email sent successfully");
        messageDialog("please check your gmail","",2);
      } catch (e) {
