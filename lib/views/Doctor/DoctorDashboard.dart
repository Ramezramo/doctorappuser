...
// import 'package:doctorapplast/VideoCall/utils/consts.txt';
import 'package:doctorapplast/en.dart';
import 'package:doctorapplast/views/incoming_call_image_name.dart';
import 'package:doctorapplast/main.dart';
import 'package:doctorapplast/modals/DoctorAppointmentClass.dart';
import 'package:doctorapplast/modals/DoctorPastAppointmentsClass.dart';
import 'package:doctorapplast/views/Doctor/DoctorAllAppointments.dart';
import 'package:doctorapplast/views/Doctor/DoctorAppointmentDetails.dart';
import 'package:doctorapplast/views/Doctor/DoctorProfileWithRating.dart';
...
// import '../../VideoCall/managers/call_manager.txt';
...
class _DoctorDashboardState extends State<DoctorDashboard> {
  ...
  fetchDoctorAppointment() async{
    ...
    print(Uri.parse("$SERVER_ADDRESS/api/doctoruappointment?doctor_id=$doctorId"));
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          try {
            ...
            print('subscription================${doctorProfileWithRating!.data!.isSubscription}');
            ...
            if(doctorProfileWithRating!.data!.isSubscription == 1){
              ...
              print('subscription==============2======${doctorProfileWithRating!.data!.isSubscription}');
            }
            // ;
            ...
            children: [
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: doctorProfileWithRating!.data!.image == "https://demo.freaktemplate.com/bookappointment/public/upload/doctors/user.png" ? "" : doctorProfileWithRating!.data!.image!,
                  height: 85,
                  width: 85,
                  fit: BoxFit.cover,
