...
// import 'package:doctorapplast/views/ChatScreen.dart';
...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((value) {
      ...
      loginCheckuser = value.getBool("isLoggedIn") ?? false;
      loginCheckdoctor = value.getBool("isLoggedInAsDoctor") ?? false;
      setState(() {});
  ...
  bool st = false;
  bool loginCheckdoctor = false;
  bool loginCheckuser = false;
                                            ...
                                            leading: ClipRRect(
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Container(
                                                  ...
                                                  child:
                                                  CachedNetworkImage(
                                                    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNs_n45qtt9UH5ZIFAJ0GhX6n-ETfpk-eH8Ni87VCAb2gGLyQk6AglG64dhQ&s",
